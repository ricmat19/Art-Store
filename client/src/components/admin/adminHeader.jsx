        ...
        <div className="navbar-div">
                ...
                <form>
                    <div ref={signinRef} className="sign-content">
                        ...
                        <div className="sign-footer">
                            ...
                            <div className="modal-link" onClick={displaySignup}><span>create account</span></div>
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div className={resetModal}>
                <form> 
                    <div ref={resetRef} className="sign-content">
                        ...
                        <div className="sign-footer">
                            <div className="modal-link" onClick={displaySignin}><span>Back to signin in</span></div>
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div>
                ...
                <nav className="navbar">
                    <a href="/admin/home"><p className="title">home</p></a>
                    <a href="/admin/collection/2D"><p className="title">store</p></a>
                    <a href="/admin/about"><p className="title">info</p></a>
